        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialLatitude = table.Column<float>(nullable: false),
                    InitialLongitude = table.Column<float>(nullable: false),
                    ReturnedLatitude = table.Column<float>(nullable: false),
                    ReturnedLongitude = table.Column<float>(nullable: false),
